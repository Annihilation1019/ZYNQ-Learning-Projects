...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../BRAM_IP_TEST.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../BRAM_IP_TEST.gen/sources_1/ip/ila_0/hdl/verilog" \
