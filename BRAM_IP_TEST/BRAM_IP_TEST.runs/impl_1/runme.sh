...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/BRAM_IP_TEST/BRAM_IP_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_TEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BRAM_TEST.tcl -notrace
