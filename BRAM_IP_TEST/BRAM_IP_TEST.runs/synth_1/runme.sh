...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/BRAM_IP_TEST/BRAM_IP_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_TEST.tcl
