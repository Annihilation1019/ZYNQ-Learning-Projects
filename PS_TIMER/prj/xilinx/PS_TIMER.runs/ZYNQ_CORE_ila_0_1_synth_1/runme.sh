...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/PS_TIMER/prj/xilinx/PS_TIMER.runs/ZYNQ_CORE_ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_ila_0_1.tcl
