...
#
# Script generated by Vivado on Tue Feb 11 19:41:40 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Programs/Workspace/SmartZYNQ_SP2/HDMI_DRIVER1/HDMI_DRIVER1.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
