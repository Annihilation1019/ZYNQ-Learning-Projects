...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/XADC_TEST/XADC_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_TEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source XADC_TEST.tcl -notrace
