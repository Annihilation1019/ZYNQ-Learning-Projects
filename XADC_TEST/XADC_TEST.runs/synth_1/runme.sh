...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/XADC_TEST/XADC_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XADC_TEST.tcl
