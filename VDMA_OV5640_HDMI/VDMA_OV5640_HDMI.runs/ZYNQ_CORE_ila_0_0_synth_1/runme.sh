...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/VDMA_OV5640_HDMI/VDMA_OV5640_HDMI.runs/ZYNQ_CORE_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_ila_0_0.tcl
