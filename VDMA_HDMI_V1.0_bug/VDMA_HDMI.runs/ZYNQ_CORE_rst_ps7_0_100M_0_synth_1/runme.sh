...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/VDMA_HDMI/VDMA_HDMI.runs/ZYNQ_CORE_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_rst_ps7_0_100M_0.tcl
