...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/VIO_TEST/VIO_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VIO_TEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VIO_TEST.tcl -notrace
