...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/VIO_TEST/VIO_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VIO_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VIO_TEST.tcl
