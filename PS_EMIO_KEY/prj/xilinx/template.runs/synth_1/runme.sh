...
HD_PWD='d:/Programs/Workspace/SmartZYNQ_SP2/PS_EMIO_KEY/prj/xilinx/template.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EMIO_KEY_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EMIO_KEY_wrapper.tcl
