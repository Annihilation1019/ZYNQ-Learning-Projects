...
HD_PWD='d:/Programs/Workspace/SmartZYNQ_SP2/PS_EMIO_KEY/prj/xilinx/template.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EMIO_KEY_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EMIO_KEY_wrapper.tcl -notrace
