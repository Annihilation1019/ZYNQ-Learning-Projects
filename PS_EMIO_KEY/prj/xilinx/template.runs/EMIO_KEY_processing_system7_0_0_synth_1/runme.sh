...
HD_PWD='d:/Programs/Workspace/SmartZYNQ_SP2/PS_EMIO_KEY/prj/xilinx/template.runs/EMIO_KEY_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EMIO_KEY_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EMIO_KEY_processing_system7_0_0.tcl
