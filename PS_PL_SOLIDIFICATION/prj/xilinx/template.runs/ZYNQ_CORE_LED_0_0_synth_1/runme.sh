...
HD_PWD='d:/Programs/Workspace/SmartZYNQ_SP2/PS_TIMER/prj/xilinx/template.runs/ZYNQ_CORE_LED_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_LED_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_LED_0_0.tcl
