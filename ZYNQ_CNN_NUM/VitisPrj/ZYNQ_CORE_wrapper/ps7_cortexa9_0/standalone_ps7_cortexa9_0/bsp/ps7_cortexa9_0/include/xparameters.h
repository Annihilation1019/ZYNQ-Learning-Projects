...
/* Definitions for peripheral CYCLE_NUM_0 */
#define XPAR_CYCLE_NUM_0_DEVICE_ID 0
#define XPAR_CYCLE_NUM_0_S00_AXI_BASEADDR 0x43C00000
#define XPAR_CYCLE_NUM_0_S00_AXI_HIGHADDR 0x43C0FFFF
