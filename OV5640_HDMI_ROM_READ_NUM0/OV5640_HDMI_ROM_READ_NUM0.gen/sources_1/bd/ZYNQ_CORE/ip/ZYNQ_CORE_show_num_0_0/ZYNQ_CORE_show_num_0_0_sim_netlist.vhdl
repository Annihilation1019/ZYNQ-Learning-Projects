...
-- Command     : write_vhdl -force -mode funcsim -rename_top ZYNQ_CORE_show_num_0_0 -prefix
--               ZYNQ_CORE_show_num_0_0_ ZYNQ_CORE_show_num_0_0_sim_netlist.vhdl
...
entity ZYNQ_CORE_show_num_0_0_show_num is
  port (
...
end ZYNQ_CORE_show_num_0_0_show_num;

architecture STRUCTURE of ZYNQ_CORE_show_num_0_0_show_num is
  ...
  signal \rd_addr[13]_i_1_n_0\ : STD_LOGIC;
  signal \rd_addr[13]_i_3_n_0\ : STD_LOGIC;
  signal \rd_addr[13]_i_4_n_0\ : STD_LOGIC;
  signal \rd_addr[13]_i_5_n_0\ : STD_LOGIC;
  signal \rd_addr[13]_i_6_n_0\ : STD_LOGIC;
  signal \rd_addr[13]_i_7_n_0\ : STD_LOGIC;
  ...
  signal \rd_addr_reg[13]_i_2_n_3\ : STD_LOGIC;
  signal \rd_addr_reg[13]_i_2_n_6\ : STD_LOGIC;
  signal \rd_addr_reg[13]_i_2_n_7\ : STD_LOGIC;
  ...
  signal \NLW_rd_addr_reg[13]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_rd_addr_reg[13]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  attribute ADDER_THRESHOLD : integer;
  attribute ADDER_THRESHOLD of \rd_addr_reg[11]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \rd_addr_reg[13]_i_2\ : label is 11;
...
\rd_addr[11]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr[11]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr[11]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr[11]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr[13]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAABAAAAAAABBAB"
    )
        port map (
      I0 => video_vsync,
...
\rd_addr[13]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\rd_addr[13]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\rd_addr[13]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr[13]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr[7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr[7]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr[7]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_addr_reg[13]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \rd_addr_reg[11]_i_1_n_0\,
      CO(3 downto 1) => \NLW_rd_addr_reg[13]_i_2_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \rd_addr_reg[13]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_rd_addr_reg[13]_i_2_O_UNCONNECTED\(3 downto 2),
      O(1) => \rd_addr_reg[13]_i_2_n_6\,
      O(0) => \rd_addr_reg[13]_i_2_n_7\,
      S(3 downto 2) => B"00",
      S(1) => \rd_addr[13]_i_6_n_0\,
      S(0) => \rd_addr[13]_i_7_n_0\
    );
...
\rgb_data_out[23]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000007F"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZYNQ_CORE_show_num_0_0 is
  port (
    pclk : in STD_LOGIC;
    rstn : in STD_LOGIC;
    pixel_x_in : in STD_LOGIC_VECTOR ( 11 downto 0 );
  ...
  attribute NotValidForBitStream of ZYNQ_CORE_show_num_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of ZYNQ_CORE_show_num_0_0 : entity is "ZYNQ_CORE_show_num_0_0,show_num,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of ZYNQ_CORE_show_num_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of ZYNQ_CORE_show_num_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of ZYNQ_CORE_show_num_0_0 : entity is "show_num,Vivado 2023.1";
end ZYNQ_CORE_show_num_0_0;

architecture STRUCTURE of ZYNQ_CORE_show_num_0_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of rstn : signal is "xilinx.com:signal:reset:1.0 rstn RST";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of rstn : signal is "XIL_INTERFACENAME rstn, POLARITY ACTIVE_LOW, INSERT_VIP 0";
begin
inst: entity work.ZYNQ_CORE_show_num_0_0_show_num
     port map (
      pclk => pclk,
