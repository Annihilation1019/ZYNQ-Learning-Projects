...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/OV5640_HDMI_with_IdentiBox/OV5640_HDMI_with_IdentiBox.runs/ZYNQ_CORE_border_adder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_border_adder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_border_adder_0_0.tcl
