...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/PL_DDR_PS_TEST/PL_DDR_PS_TEST.runs/ZYNQ_CORE_auto_us_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_auto_us_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_auto_us_0.tcl
