...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/PL_SIM_TEST/PL_SIM_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count_module.tcl
