...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/PS_BRAM/PS_BRAM.runs/ZYNQ_CORE_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_processing_system7_0_1.tcl
