...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/PS_PL_REG/PS_PL_REG.runs/ZYNQ_CORE_PS_PL_REG_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_PS_PL_REG_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_PS_PL_REG_0_0.tcl
