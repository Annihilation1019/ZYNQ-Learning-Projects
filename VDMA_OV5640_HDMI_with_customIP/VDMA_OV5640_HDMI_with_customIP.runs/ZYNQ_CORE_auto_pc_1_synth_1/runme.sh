...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/VDMA_OV5640_HDMI_with_customIP/VDMA_OV5640_HDMI_with_customIP.runs/ZYNQ_CORE_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_auto_pc_1.tcl
