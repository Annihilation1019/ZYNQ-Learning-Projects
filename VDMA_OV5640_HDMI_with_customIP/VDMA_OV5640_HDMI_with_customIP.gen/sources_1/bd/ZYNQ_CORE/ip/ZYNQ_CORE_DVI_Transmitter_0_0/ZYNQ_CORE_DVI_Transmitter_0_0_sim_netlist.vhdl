...
--               d:/Programs/Workspace/SmartZYNQ_SP2/VDMA_OV5640_HDMI_with_customIP/VDMA_OV5640_HDMI_with_customIP.gen/sources_1/bd/ZYNQ_CORE/ip/ZYNQ_CORE_DVI_Transmitter_0_0/ZYNQ_CORE_DVI_Transmitter_0_0_sim_netlist.vhdl
...
entity ZYNQ_CORE_DVI_Transmitter_0_0_encoder is
  port (
  ...
  attribute ORIG_REF_NAME of ZYNQ_CORE_DVI_Transmitter_0_0_encoder : entity is "encoder";
end ZYNQ_CORE_DVI_Transmitter_0_0_encoder;

architecture STRUCTURE of ZYNQ_CORE_DVI_Transmitter_0_0_encoder is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZYNQ_CORE_DVI_Transmitter_0_0_encoder_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZYNQ_CORE_DVI_Transmitter_0_0_encoder_0 : entity is "encoder";
end ZYNQ_CORE_DVI_Transmitter_0_0_encoder_0;

architecture STRUCTURE of ZYNQ_CORE_DVI_Transmitter_0_0_encoder_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZYNQ_CORE_DVI_Transmitter_0_0_encoder_1 is
  port (
    Q : out STD_LOGIC_VECTOR ( 0 to 0 );
    \cnt_reg[2]_0\ : out STD_LOGIC;
    \cnt_reg[4]_0\ : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZYNQ_CORE_DVI_Transmitter_0_0_encoder_1 : entity is "encoder";
end ZYNQ_CORE_DVI_Transmitter_0_0_encoder_1;

architecture STRUCTURE of ZYNQ_CORE_DVI_Transmitter_0_0_encoder_1 is
  signal \^q\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal cnt : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser : entity is "par_to_ser";
end ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser;

architecture STRUCTURE of ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_2 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_2 : entity is "par_to_ser";
end ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_2;

architecture STRUCTURE of ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_2 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_3 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_3 : entity is "par_to_ser";
end ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_3;

architecture STRUCTURE of ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_3 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_4 is
  port (
    ser_data_clk : out STD_LOGIC_VECTOR ( 0 to 0 );
    clk_5x : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_4 : entity is "par_to_ser";
end ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_4;

architecture STRUCTURE of ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_4 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZYNQ_CORE_DVI_Transmitter_0_0_hdmi_ctrl is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZYNQ_CORE_DVI_Transmitter_0_0_hdmi_ctrl : entity is "hdmi_ctrl";
end ZYNQ_CORE_DVI_Transmitter_0_0_hdmi_ctrl;

architecture STRUCTURE of ZYNQ_CORE_DVI_Transmitter_0_0_hdmi_ctrl is
  signal c0_reg2 : STD_LOGIC;
  signal de_reg2 : STD_LOGIC;
...
encoder_inst0: entity work.ZYNQ_CORE_DVI_Transmitter_0_0_encoder
     port map (
...
encoder_inst1: entity work.ZYNQ_CORE_DVI_Transmitter_0_0_encoder_0
     port map (
      D(1) => encoder_inst0_n_3,
      D(0) => encoder_inst0_n_4,
      Q(0) => encoder_inst1_n_2,
...
encoder_inst2: entity work.ZYNQ_CORE_DVI_Transmitter_0_0_encoder_1
     port map (
...
par_to_ser_inst0: entity work.ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser
     port map (
      clk_5x => clk_5x,
...
par_to_ser_inst1: entity work.ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_2
     port map (
      clk_5x => clk_5x,
...
par_to_ser_inst2: entity work.ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_3
     port map (
      clk_5x => clk_5x,
...
par_to_ser_inst3: entity work.ZYNQ_CORE_DVI_Transmitter_0_0_par_to_ser_4
     port map (
      clk_5x => clk_5x,
...
entity ZYNQ_CORE_DVI_Transmitter_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of ZYNQ_CORE_DVI_Transmitter_0_0 : entity is "ZYNQ_CORE_DVI_Transmitter_0_0,hdmi_ctrl,{}";
  ...
  attribute X_CORE_INFO of ZYNQ_CORE_DVI_Transmitter_0_0 : entity is "hdmi_ctrl,Vivado 2023.1";
...
begin
inst: entity work.ZYNQ_CORE_DVI_Transmitter_0_0_hdmi_ctrl
     port map (
      clk_1x => clk_1x,
      clk_5x => clk_5x,
      de => de,
