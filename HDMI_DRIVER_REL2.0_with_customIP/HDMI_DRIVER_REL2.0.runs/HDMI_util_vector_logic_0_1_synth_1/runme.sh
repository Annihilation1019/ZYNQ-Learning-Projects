...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/HDMI_DRIVER_REL2.0_with_customIP/HDMI_DRIVER_REL2.0.runs/HDMI_util_vector_logic_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_util_vector_logic_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_util_vector_logic_0_1.tcl
