...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/HDMI_DRIVER_REL2.0_with_customIP/HDMI_DRIVER_REL2.0.runs/HDMI_vga_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_vga_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_vga_ctrl_0_0.tcl
