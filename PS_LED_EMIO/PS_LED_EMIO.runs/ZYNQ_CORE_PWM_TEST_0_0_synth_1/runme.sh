...
HD_PWD='D:/Programs/Workspace/SmartZYNQ_SP2/PS_LED_EMIO/PS_LED_EMIO.runs/ZYNQ_CORE_PWM_TEST_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_PWM_TEST_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_PWM_TEST_0_0.tcl
